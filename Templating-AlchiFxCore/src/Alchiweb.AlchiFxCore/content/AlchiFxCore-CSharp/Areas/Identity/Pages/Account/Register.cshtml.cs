...
namespace Company.WebApplication1.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly UserManager<AlchiUser> _userManager;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<AlchiUser> userManager,
            SignInManager<AlchiUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AlchiUser { UserName = Input.Email, Email = Input.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmer votre email",
                        $"Merci de confirmer votre compte en allant sur <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
