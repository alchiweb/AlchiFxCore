declare var pageCrudItem: Function;
        ...
        processSync(data: UserResult) {
            ...
            data.urls.forEach(url => {
                ...
                url.data.forEach(x => {
                    ...
                    this.options.defaultId = this.options.defaultId.substring(0, 1).toUpperCase() + this.options.defaultId.substring(1);
                    // Alchi -> PascalCase ------ End
                    // Alchi
                    if (typeof pageCrudItem === "function") {
                        pageCrudItem(x.typeName, x.state, x.object, this.options.defaultId);
                    }
